...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_FormBuilder_42", {
        get: function () {
            if ((this.__FormBuilder_42 == null)) {
                (this.__FormBuilder_42 = new import5.FormBuilder());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RegistrationService_44", {
        get: function () {
            if ((this.__RegistrationService_44 == null)) {
                (this.__RegistrationService_44 = new import7.RegistrationService());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ActivatedRoute_45", {
        get: function () {
            if ((this.__ActivatedRoute_45 == null)) {
                (this.__ActivatedRoute_45 = import3.ɵf(this._Router_22));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NoPreloading_46", {
        get: function () {
            if ((this.__NoPreloading_46 == null)) {
                (this.__NoPreloading_46 = new import3.NoPreloading());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreloadingStrategy_47", {
        get: function () {
            if ((this.__PreloadingStrategy_47 == null)) {
                (this.__PreloadingStrategy_47 = this._NoPreloading_46);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RouterPreloader_48", {
        get: function () {
            if ((this.__RouterPreloader_48 == null)) {
                (this.__RouterPreloader_48 = new import3.RouterPreloader(this._Router_22, this._NgModuleFactoryLoader_20, this._Compiler_19, this, this._PreloadingStrategy_47));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreloadAllModules_49", {
        get: function () {
            if ((this.__PreloadAllModules_49 == null)) {
                (this.__PreloadAllModules_49 = new import3.PreloadAllModules());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_50", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_50 == null)) {
                (this.__ROUTER_INITIALIZER_50 = import3.ɵi(this._ɵg_3));
            }
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import6.RegistrationModule)) {
            return this._RegistrationModule_12;
        }
        if ((token === import3.ɵa)) {
            return this._ɵa_13;
        }
        ...
        if ((token === import7.RegistrationService)) {
            return this._RegistrationService_44;
        }
        ...
        if ((token === import3.PreloadingStrategy)) {
            return this._PreloadingStrategy_47;
        }
        if ((token === import3.RouterPreloader)) {
            return this._RouterPreloader_48;
        }
